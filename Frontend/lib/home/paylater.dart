...
class Paylater extends StatefulWidget {
  ...
  Paylater({Key key, @required this.appointmentid, @required this.docfees}) : super(key: key);
...
class _PaylaterState extends State<Paylater> {
  ...
  Future updatepaymentstatus(BuildContext context) async{  //updates the status to paid if the payment is successful
    //print(appointmentId);

    var response = await http.post(Uri.parse(ApiUrl.baseurl+"updatepaymentstatus.php"),body:{
